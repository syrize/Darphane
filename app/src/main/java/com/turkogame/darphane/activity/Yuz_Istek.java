...
public class Yuz_Istek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yuz_istek);
        reklam_yukle();
            ...
            public void onClick(View v) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback(){
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        startActivity(new Intent(Yuz_Istek.this, MainMenu.class));
                        finishAffinity();
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Yüz Falı İstek");
    ...
    public void istek_gonder(){
        ...
        String md5= AppConfig.md5(kullanici_id+"yuz_faliPOST");
        ...
        String url = AppConfig.URL + "/yuz_fali.php";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (kontrol.getString("hata")=="false"){
                                ...
                                sharedPreferences = getApplicationContext().getSharedPreferences("YuzFali", 0);
                                ...
                                if (mInterstitialAd != null) {
                                    ...
                                    mInterstitialAd.show(Yuz_Istek.this);
