...
public class Kahve_Istek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kahve_istek);
       ...
       // Toast.makeText(Kahve_Istek.this, falci_id, Toast.LENGTH_LONG).show();

        initToolbar();
        spinner_doldur();

        Button  niyet = findViewById(R.id.btn_niyet);
        ...
        niyet.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {

                resim1.setImageResource(R.drawable.benim_niyetime1);
                resim1.buildDrawingCache();
                Bitmap bmap = resim1.getDrawingCache();
                ByteArrayOutputStream bos = new ByteArrayOutputStream();
                bmap.compress(Bitmap.CompressFormat.PNG,100,bos);
                byte[] bb = bos.toByteArray();
                imagebase64_1 = Base64.encodeToString(bb, Base64.DEFAULT);

                resim2.setImageResource(R.drawable.benim_niyetime1);
                resim2.buildDrawingCache();
                Bitmap bmap2 = resim2.getDrawingCache();
                ByteArrayOutputStream bos2 = new ByteArrayOutputStream();
                bmap2.compress(Bitmap.CompressFormat.PNG,100,bos2);
                byte[] bb2 = bos.toByteArray();
                imagebase64_2 = Base64.encodeToString(bb2, Base64.DEFAULT);

                resim3.setImageResource(R.drawable.benim_niyetime1);
                resim3.buildDrawingCache();
                Bitmap bmap3 = resim3.getDrawingCache();
                ByteArrayOutputStream bos3 = new ByteArrayOutputStream();
                bmap3.compress(Bitmap.CompressFormat.PNG,100,bos3);
                byte[] bb3 = bos.toByteArray();
                imagebase64_3 = Base64.encodeToString(bb3, Base64.DEFAULT);
            ...
            public void onClick(View v) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback(){
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        startActivity(new Intent(Kahve_Istek.this, MainMenu.class));
                        finishAffinity();
                ...
                //mInterstitialAd.show(Kahve_Istek.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CAMERA_REQUEST && resultCode == RESULT_OK) {
            ...
            if(kontrol==3) {
                resim3.setImageBitmap(photo);
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
                Bitmap bitmap = photo;
                bitmap.compress(Bitmap.CompressFormat.JPEG, 100, baos);
                byte[] imageBytes = baos.toByteArray();
                imagebase64_3 = Base64.encodeToString(imageBytes, Base64.DEFAULT);
            }
        ...
        if (requestCode == SELECT_IMAGE && resultCode == RESULT_OK){
            ...
            if(kontrol==3) {
                ...
                resim3.setImageURI(imageUri);

                BitmapDrawable drawable = (BitmapDrawable) resim3.getDrawable();
                photo = drawable.getBitmap();
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Kahve Falı İstek");
    ...
    public void istek_gonder(){
        ...
        String md5= AppConfig.md5(kullanici_id+"kahve_faliPOST");
        ...
        try {
            ...
            object.put("resim3", imagebase64_3);
            object.put("resim3_uzanti", "jpg");
        ...
        String url = AppConfig.URL + "/kahve_fali.php";
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (kontrol.getString("hata")=="false"){
                                ...
                                sharedPreferences = getApplicationContext().getSharedPreferences("KahveFali", 0);
